<div id="contact" class="tab-pane fade">
	<div class="row">
		<!-- email form -->
		<div class="col-lg-6">
			<h1 class="heading-no-margin text-center">Contact Me</h1>
			<p class="text-center">Have a project that you'd like to discuss? Shoot me an email!</p>
			<hr>
		...
		<!-- socials -->
		<div class="col-lg-6">
			<h1 class="heading-no-margin text-center">Follow Me</h1>
			<p class="text-center">Let's get social and get to know me more!</p>
			<hr>
